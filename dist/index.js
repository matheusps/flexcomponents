...
var FlexContainer = function (_a) {
    ...
    return (React.createElement("div", { style: __assign({ order: props.order, flexShrink: props.shrink, flexGrow: props.grow, flexBasis: props.basis, alignSelf: props.self, display: props.inline ? 'inline-flex' : 'flex', flexDirection: props.direction, flexWrap: props.wrap, justifyContent: props.justify, alignItems: props.items, alignContent: props.content }, styles) }, children));
};
...
var FlexItem = function (_a) {
    ...
    return (React.createElement("div", { style: __assign({ display: 'flex', order: props.order, flexShrink: props.shrink, flexGrow: props.grow, flexBasis: props.basis, alignSelf: props.self }, styles) }, children));
};
